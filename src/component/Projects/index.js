            ...
            >
                ...
                <div className="project-skills">
                    {project.skills.map((skill, idx) => (
                        <span className="project-skill" key={idx}>{skill}</span>
                    ))}
                </div>
